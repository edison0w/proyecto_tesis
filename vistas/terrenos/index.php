        ...
        <div id="margen-top" class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9 text-center">
                    <img src="../../recursos/img/terrenos.jpg" alt="" class="img-thumbnail" style="width: 50%"/>
                    <h4><?php echo $array_ini['terrenos'] ?></h4>
                    <span class="text-muted">
                        Actualmente la Junta General de Riego Chambo Guano cuenta con 99484 terrenos repartidos en 600 socios.
                    </span>
                </div>
            </div>
